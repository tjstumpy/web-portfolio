      ...
      <div className="flex flex-col text-text-primary bg-light-bg w-[80%] h-full">
        ...
        <div className="flex flex-col items-center justify-center gap-8 pb-0 h-full drop-shadow-lg md:pb-16">
          ...
          <div className="flex items-center gap-8 text-text-secondary text-small font-light">
            <a href={project.links.github} target="_blank" rel="noopener noreferrer" className="cursor-pointer duration-300 hover:text-text-primary">
              <FontAwesomeIcon icon={faGithub} />
            </a>
            <span>|</span>
            <a href={project.links.figma} target="_blank" rel="noopener noreferrer" className="cursor-pointer duration-300 hover:text-text-primary">
